      ...
      <div className="relative overflow-hidden rounded-[32px] grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-12 items-center p-12 md:p-16 bg-gradient-to-br from-primary-800 to-primary-600 text-white">
        ...
        <div className="relative">
          <h2 className="text-[clamp(28px,3.4vw,44px)] font-semibold tracking-[-0.03em] leading-[1.1]">
            Prêt à activer KeiwaBot Customer AI dans votre établissement ?
          </h2>
          <p
            className="mt-5 text-[17px] leading-[1.5] max-w-[440px]"
            style={{ color: "oklch(0.9 0.03 75)" }}
          >
            Demandez une démo : nous configurons votre agent sur votre métier,
            vos canaux et votre politique client, avec mise en service sous 48h.
          </p>
          ...
          {!sent ? (
            ...
            >
              ...
              <div className="text-sm text-neutral-500 mb-6">
                On vous rappelle sous 2h ouvrées. Aucun engagement.
              </div>

              {[
                {
                  label: "Votre nom",
                  placeholder: "Rita Kouassi",
                  type: "text",
                },
                {
                  label: "WhatsApp",
              ...
              <div className="flex flex-col gap-1.5 mb-4">
                ...
                <select
                  required
                  className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-sm focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all text-neutral-700 bg-white"
                >
              ...
              <div className="flex flex-col gap-1.5 mb-6">
                ...
                <input
                  placeholder="Maquis Chez Rita, Cocody"
                  className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-sm focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all placeholder:text-neutral-400"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white font-medium py-3.5 rounded-xl text-base transition-all shadow-[0_6px_20px_-4px_oklch(0.42_0.09_165/0.35)]"
              >
            ...
            <div className="text-center py-10">
              ...
              <p className="text-sm text-neutral-500 mt-2">
                On vous rappelle sous 2h ouvrées. À très vite 🌿
              </p>
            </div>
          )}
        </div>
