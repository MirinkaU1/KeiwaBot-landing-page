...
const SCRIPT = [
  {
    who: "user",
    text: "Bonjour, vous livrez ce soir vers Cocody ?",
    t: "19:42",
  },
  {
    who: "bot",
    text: "Bonsoir 🌙 Oui, on livre à Cocody jusqu'à 23h. Vous voulez voir notre menu ?",
    t: "19:42",
  },
  { who: "user", text: "Oui s'il vous plaît", t: "19:43" },
  {
    who: "bot",
    text: "Je vous envoie notre Top 3 du soir : Attiéké poisson braisé (3 500 F), Poulet yassa (4 000 F), Garba spécial (2 500 F). Je note pour quelle heure ?",
    t: "19:43",
  },
  { who: "user", text: "Un attiéké et un yassa pour 20h30", t: "19:44" },
  {
    who: "bot",
    text: "Parfait ✅ 7 500 F au total, livraison 1 000 F. Je vous envoie le lien de paiement Wave dans 10s.",
    t: "19:44",
  },
];
...
function Bubble({ msg }) {
  ...
  return (
    <div
      className={`wa-in max-w-[78%] px-3 py-2 rounded-[14px] text-[13px] leading-[1.35] ${
        isUser
    ...
    <div className="w-[300px] h-[600px] mx-auto rounded-[42px] bg-neutral-900 p-[10px] shadow-[0_60px_120px_-40px_oklch(0.42_0.09_165/0.35),0_40px_80px_-30px_oklch(0.2_0.01_75/0.25)] relative">
      ...
      <div className="w-full h-full bg-[#ECE5DD] dark:bg-[#0B1013] rounded-[34px] overflow-hidden flex flex-col">
        <div className="bg-primary-700 text-white pt-14 pb-3 px-4 flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-accent-500 text-neutral-900 grid place-items-center font-bold text-sm">
            K
          </div>
            ...
            <div className="wa-in self-start bg-white dark:bg-[#1F2C33] px-3 py-2 rounded-[14px] rounded-tl-[4px] shadow-[0_1px_1px_rgba(0,0,0,0.05)]">
              <div className="flex gap-1 py-0.5">
                {[0, 1, 2].map((i) => (
                  <span
                    key={i}
                    className="typing-bounce w-1.5 h-1.5 rounded-full bg-[#667781] block"
