    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-3.5 flex items-center gap-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="#login"
            className="hidden sm:inline-flex text-sm font-medium text-neutral-700 dark:text-neutral-300 px-3 py-1.5 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg transition-colors"
          >
            Connexion
          </a>
          <a
            href="#cta"
            className="inline-flex items-center text-sm font-medium bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-xl transition-colors shadow-[0_0_0_0_oklch(0.42_0.09_165/0),0_6px_20px_-4px_oklch(0.42_0.09_165/0.35)] hover:shadow-[0_8px_24px_-4px_oklch(0.42_0.09_165/0.45)]"
          >
            Demander une démo
          </a>
        </div>
